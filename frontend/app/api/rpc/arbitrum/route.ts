 ...
 * API key (ARBITRUM_RPC_URL, server-only env var — currently Alchemy) out of
 * the browser bundle entirely. The client (see wagmi.ts's transports) points
 * its Arbitrum viem transport at this same-origin route instead of the
 * provider directly; this just forwards the JSON-RPC body verbatim and

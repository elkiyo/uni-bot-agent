...
BYTECODE=$(forge inspect src/compound/VaultFactoryArbCompoundV3.sol:VaultFactoryArbCompoundV3 bytecode)
...
echo "Deployando VaultFactoryArbCompoundV3 a Arbitrum — confirmá en el Ledger cuando te lo pida..."
